    ...
    formatCxTimeMessage: (timeUntilDeadline) => {
        if (timeUntilDeadline.totalMinutes > 0) {
            if (timeUntilDeadline.hours > 0) {
                return `<a:X_Uwaga2:1297532628395622440> **Pozostały czas na zbicie bossa CX: ${timeUntilDeadline.hours}h ${timeUntilDeadline.minutes}min** <a:X_Uwaga2:1297532628395622440>`;
            } else {
                return `<a:X_Uwaga2:1297532628395622440> **Pozostały czas na zbicie bossa CX: ${timeUntilDeadline.minutes}min** <a:X_Uwaga2:1297532628395622440>`;
            }
        } else {
            return `<a:X_Uwaga2:1297532628395622440> **Czas na zbicie bossa CX już minął!** <a:X_Uwaga2:1297532628395622440>`;
        }
    },
