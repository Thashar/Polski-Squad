...
- **Komunikat:** `messages.cxReminderMessage()` — "PRZYPOMNIENIE O BOSSIE CX" + czas do deadline 17:45 (`calculateTimeUntilCxDeadline()`, `formatCxTimeMessage()`) + ostrzeżenie "Jeśli boss CX nie zostanie zbity, przepadną WSZYSTKIE nagrody!"
