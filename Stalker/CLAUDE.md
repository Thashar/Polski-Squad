...
- **Parsowanie AI w trybie CX:** `analyzeResultsImagesBatch(filepaths, clanNicks, { anyScore: true })` — parser `parseAIResponse()` NIE stosuje górnej granicy wyniku 999999 (obrażenia na bossie CX przekraczają ten limit i wszyscy gracze odpadali na walidacji). Liczy się tylko odczytany nick, wynik jest ignorowany
