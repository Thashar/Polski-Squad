...
client.once(Events.ClientReady, async () => {
    logger.success('✅ StalkerEN ready - Boss punishments (OCR), vacations, multi-server support');
    ...
    for (const guild of client.guilds.cache.values()) {
        ...
        if (!serverConfig) {
            ...
            logger.warn(`   Add configuration for this server in StalkerEN/config/servers.json`);
        } else {
