...
- **Klik w licznik → ephemeral z listą osób** (`collectReactors` + `_handleBroadcastReactionButton`): kto zareagował, pogrupowany po serwerze, z liczbą przy nazwie serwera. Zbiorczy `➕` listuje wszystkie emotki, które zlicza, z emotką przy każdej osobie. Boty pomijane
