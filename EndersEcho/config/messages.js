const pol = {
    ...
    challengeErrLimit: '❌ Masz już **{count}** otwarte wyzwania (maksimum: **{max}**). Zakończ któreś, zanim rzucisz kolejne.',
    ...
    challengeErrAcceptLimit: '❌ Masz już **{count}** otwarte wyzwania (maksimum: **{max}**). Zakończ któreś, zanim przyjmiesz kolejne.',
...
const eng = {
    ...
    challengeErrLimit: '❌ You already have **{count}** open challenges (maximum: **{max}**). Finish one before starting another.',
    ...
    challengeErrAcceptLimit: '❌ You already have **{count}** open challenges (maximum: **{max}**). Finish one before accepting another.',
