const pol = {
    ...
    challengeErrAcceptLimit: '❌ Masz już maksymalną liczbę otwartych wyzwań ({limit}). Zakończ któreś, zanim przyjmiesz kolejne.',
...
const eng = {
    ...
    challengeErrAcceptLimit: '❌ You already have the maximum number of open challenges ({limit}). Finish one before accepting another.',
