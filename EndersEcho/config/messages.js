const pol = {
    ...
    challengeWizardTitle: '⚔️ Rzuć wyzwanie',
    challengeSelectPlayer: 'Wybierz przeciwnika z listy poniżej. Przy każdym nicku widnieje serwer, z którego gracz pochodzi.',
    challengeSelectPlayerPlaceholder: 'Wybierz gracza...',
    challengeSelectBoss: 'Wybierz bossa, na którym rozegracie pojedynek.',
    challengeSelectBossPlaceholder: 'Wybierz bossa...',
    challengeFieldYourRecord: '🏆 Twój rekord',
    challengeFieldAllowedRange: '⚖️ Dozwolony przedział (±{percent}%)',
    challengeFieldOpponent: '🎯 Przeciwnik',
    challengeRangeFooter: 'Na liście są wyłącznie gracze z rekordem w tym przedziale — ze wszystkich serwerów.',
    challengeRecordRule: '⚖️ Wyzwanie musi być wyrównane — rekord przeciwnika może różnić się od Twojego maksymalnie o **{percent}%**.',
    challengeNoPlayersInRange: '❌ Na żadnym serwerze nie ma gracza z rekordem w granicach ±{percent}% Twojego (**{min}** – **{max}**). Spróbuj ponownie, gdy ktoś dorówna Twojemu wynikowi.',
...
const eng = {
    ...
    challengeWizardTitle: '⚔️ Send a challenge',
    challengeSelectPlayer: 'Pick your opponent from the list below. Each nickname is followed by the server the player comes from.',
    challengeSelectPlayerPlaceholder: 'Select a player...',
    challengeSelectBoss: 'Select the boss you will duel on.',
    challengeSelectBossPlaceholder: 'Select a boss...',
    challengeFieldYourRecord: '🏆 Your record',
    challengeFieldAllowedRange: '⚖️ Allowed range (±{percent}%)',
    challengeFieldOpponent: '🎯 Opponent',
    challengeRangeFooter: 'The list shows only players whose record falls inside this range — from every server.',
    challengeRecordRule: '⚖️ A challenge must be even — the opponent\'s record may differ from yours by at most **{percent}%**.',
    challengeNoPlayersInRange: '❌ No server has a player with a record within ±{percent}% of yours (**{min}** – **{max}**). Try again once someone catches up with your score.',
