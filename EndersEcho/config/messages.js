const pol = {
    ...
    challengeDmAcceptedNotice: '⚔️ **{opponent}** przyjął Twoje wyzwanie na bossie **{boss}**! Wrzuć **3 wyniki** komendą `/update`.',
    challengeDmDeclinedNotice: '❌ **{opponent}** odrzucił Twoje wyzwanie na bossie **{boss}**.',
    challengeDmInviteExpiredNotice: '⏳ **{opponent}** nie odpowiedział na Twoje wyzwanie na bossie **{boss}** w ciągu 48 godzin — zaproszenie wygasło.',
    ...
    challengeResultWin: '🏆 **Wygrałeś!**',
    challengeResultLoss: '💔 **Przegrałeś.**',
...
const eng = {
    ...
    challengeDmAcceptedNotice: '⚔️ **{opponent}** accepted your challenge on boss **{boss}**! Submit **3 scores** using `/update`.',
