const pol = {
    ...
    challengeSelectPlayer: '⚔️ **Rzuć wyzwanie**\nWybierz gracza, któremu chcesz rzucić wyzwanie — przy nicku serwer, z którego pochodzi.',
    ...
    challengeRecordRange: '⚖️ Twój rekord: **{record}**. Wyzwać możesz tylko gracza z rekordem od **{min}** do **{max}** (±{percent}%) — na liście są wyłącznie tacy gracze, ze wszystkich serwerów.',
...
const eng = {
    ...
    challengeSelectPlayer: '⚔️ **Send a challenge**\nSelect the player you want to challenge — their server is shown next to the nickname.',
    ...
    challengeRecordRange: '⚖️ Your record: **{record}**. You can only challenge a player whose record is between **{min}** and **{max}** (±{percent}%) — the list shows only those players, from every server.',
