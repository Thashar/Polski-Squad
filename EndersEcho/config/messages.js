const pol = {
    ...
    challengeIntro: '⚔️ **Rzuć wyzwanie**\nWybierz serwer, z którego pochodzi gracz.',
    challengeSelectServerPlaceholder: 'Wybierz serwer...',
    challengeSelectPlayer: '⚔️ **Rzuć wyzwanie**\nWybierz gracza, któremu chcesz rzucić wyzwanie.',
    challengeSelectPlayerPlaceholder: 'Wybierz gracza...',
    challengeSelectBoss: '⚔️ **Rzuć wyzwanie**\nWybierz bossa, na którym rozegracie pojedynek.',
    challengeSelectBossPlaceholder: 'Wybierz bossa...',
    challengeNoPlayers: '❌ Na tym serwerze nie ma jeszcze żadnych graczy w rankingu.',
    challengeRecordRange: '⚖️ Twój rekord: **{record}**. Wyzwać możesz tylko gracza z rekordem od **{min}** do **{max}** (±{percent}%) — na liście są wyłącznie tacy gracze.',
    challengeRecordRule: '⚖️ Wyzwanie musi być wyrównane — rekord przeciwnika może różnić się od Twojego maksymalnie o **{percent}%**.',
    challengeNoPlayersInRange: '❌ Na tym serwerze nie ma gracza z rekordem w granicach ±{percent}% Twojego (**{min}** – **{max}**). Wybierz inny serwer.',
    challengeNoBosses: '❌ Brak skonfigurowanych nazw bossów.',
    challengeSessionExpired: '❌ Sesja wyzwania wygasła. Użyj `/challenge` ponownie.',
    challengeConfirmTitle: '⚔️ Potwierdź wyzwanie',
    challengeConfirmText: 'Czy chcesz rzucić wyzwanie graczowi **{opponent}** z serwera **{guild}** na bossie **{boss}**?',
    challengeRules: 'Liczą się **3 kolejne wyniki** każdego z Was, zrobione na tym bossie po przyjęciu wyzwania. Wyniki sumują się — wygrywa wyższa suma. Wyzwanie trwa maksymalnie **72 godziny** od przyjęcia.',
    challengeConfirmYes: 'Rzuć wyzwanie',
    challengeConfirmNo: 'Anuluj',
    challengeCancelled: '❌ Wyzwanie anulowane.',
    challengeErrSelf: '❌ Nie możesz rzucić wyzwania samemu sobie.',
    challengeErrNoRecord: '❌ Nie masz jeszcze rekordu w rankingu tego serwera — najpierw wrzuć wynik komendą `/update`. Bez rekordu nie da się dobrać wyrównanego przeciwnika.',
    challengeErrRecordRange: '❌ Rekord gracza **{name}** (**{score}**) różni się od Twojego (**{record}**) o więcej niż {percent}%. Wyzwać możesz tylko gracza z rekordem od **{min}** do **{max}**.',
    challengeErrLimit: '❌ Masz już otwarte wyzwanie — jednocześnie można prowadzić tylko jedno. Zakończ je, zanim rzucisz kolejne.',
    ...
    challengeDmInviteDesc: '**{challenger}** z serwera **{guild}** rzuca Ci wyzwanie na bossie **{boss}**.',
    challengeDmInviteExpires: '⏳ Na odpowiedź masz czas do {date}.',
    challengeBtnAccept: 'Przyjmuję',
    challengeBtnDecline: 'Odrzucam',
    challengeBtnAccepted: 'Przyjęte',
    challengeBtnDeclined: 'Odrzucone',
    challengeBtnExpired: 'Wygasło',
    challengeAcceptedReply: '⚔️ Wyzwanie przyjęte! Wrzuć **3 wyniki** na bossie **{boss}** komendą `/update`.',
    challengeDeclinedReply: '❌ Wyzwanie odrzucone.',
    challengeErrNotForYou: '❌ To wyzwanie nie jest skierowane do Ciebie.',
    challengeErrGone: '❌ To wyzwanie już nie jest aktualne.',
    challengeErrAcceptLimit: '❌ Masz już otwarte wyzwanie — jednocześnie można prowadzić tylko jedno. Zakończ je, zanim przyjmiesz kolejne.',
    challengeDmAcceptedTitle: '⚔️ Wyzwanie przyjęte',
    ...
    challengeNoticeNoRunScore: '⚠️ Nie udało się odczytać **wyniku tej walki** (liczby nad „Best"), więc screen **nie został zaliczony** do wyzwania. Twój rekord zapisał się normalnie — wrzuć zdjęcie jeszcze raz, żeby doliczyło się do pojedynku.',
    ...
    challengeDmVerifiedDesc: 'Nazwa bossa **{boss}** została zatwierdzona przez administrację. Twój wynik **{score}** trafił do wyzwania.',
    challengeDmDroppedTitle: '⚠️ Wynik nie został doliczony do wyzwania',
    challengeDmDroppedTooLate: 'Nazwa bossa **{boss}** została zatwierdzona przez administrację, ale Twoje wyzwanie zdążyło się już rozstrzygnąć — wynik **{score}** nie trafił do wyzwania.',
    challengeDmDroppedNoChallenge: 'Nazwa bossa **{boss}** została zatwierdzona przez administrację, ale nie masz otwartego wyzwania na tym bossie — wynik **{score}** nie trafił do wyzwania.',
    ...
    challengeDmDroppedStale: 'Nazwa bossa z Twojego zgłoszenia nie została zatwierdzona w ciągu 72 godzin — wynik **{score}** nie trafi do wyzwania.',

    // ⚔️ Wyzwania — rezultat
    challengeDmResultTitle: '⚔️ Wyzwanie zakończone',
    challengeResultWin: '🏆 **Zwycięstwo!**',
    challengeResultLoss: '💔 **Porażka.**',
    challengeResultDraw: '🤝 **Remis!**',
    challengeResultDesc: '**{a}** vs **{b}** — boss **{boss}**',
    challengeFieldSum: 'Suma',
    challengeWinnerLine: '🏆 Zwycięzca: **{winner}**',
    challengeDrawLine: '🤝 Remis — obie sumy są identyczne.',
    challengeNoScores: '—',
    challengeBtnShare: 'Pochwal się wynikami na swoim serwerze',
    challengeBtnShared: 'Pochwalono się',
    challengeSharedOk: '✅ Wynik wyzwania opublikowany na serwerze **{guild}**.',
    challengeSharedAlready: 'ℹ️ Ten wynik został już opublikowany.',
    challengeShareNoChannel: '❌ Serwer **{guild}** nie ma skonfigurowanego kanału bota — nie ma gdzie opublikować wyniku.',
    ...
    challengeDeletedProfile: '🗑️ Profil usunięty',
    challengeStatusWon: '🏆 Wygrana',
    challengeStatusLost: '💔 Przegrana',
    challengeStatusDraw: '🤝 Remis',
    challengeStatusUnresolved: '❓ Nierozstrzygnięte',
    challengeStatusCancelled: '🚫 Anulowane',
    challengeStatusDeclined: '❌ Odrzucone',
    challengeStatusExpired: '⏳ Wygasłe',
    challengeStatusPending: '✉️ Oczekuje na odpowiedź',
    challengeStatusActive: '⚔️ W toku',
};
...
const eng = {
    ...
    // ⚔️ Challenges (/challenge)
    challengeIntro: '⚔️ **Send a challenge**\nSelect the server the player comes from.',
    challengeSelectServerPlaceholder: 'Select a server...',
    challengeSelectPlayer: '⚔️ **Send a challenge**\nSelect the player you want to challenge.',
    challengeSelectPlayerPlaceholder: 'Select a player...',
    challengeSelectBoss: '⚔️ **Send a challenge**\nSelect the boss you will duel on.',
    challengeSelectBossPlaceholder: 'Select a boss...',
    challengeNoPlayers: '❌ There are no players in this server\'s ranking yet.',
    challengeRecordRange: '⚖️ Your record: **{record}**. You can only challenge a player whose record is between **{min}** and **{max}** (±{percent}%) — the list shows only those players.',
    challengeRecordRule: '⚖️ A challenge must be even — the opponent\'s record may differ from yours by at most **{percent}%**.',
    challengeNoPlayersInRange: '❌ This server has no player with a record within ±{percent}% of yours (**{min}** – **{max}**). Pick another server.',
    challengeNoBosses: '❌ No boss names are configured.',
    challengeSessionExpired: '❌ This challenge session has expired. Use `/challenge` again.',
    challengeConfirmTitle: '⚔️ Confirm the challenge',
    challengeConfirmText: 'Do you want to challenge **{opponent}** from **{guild}** on boss **{boss}**?',
    challengeRules: 'Your **next 3 scores** on that boss, submitted after the challenge is accepted, count for each of you. The scores are summed up — the higher total wins. A challenge lasts at most **72 hours** from acceptance.',
    challengeConfirmYes: 'Send challenge',
    challengeConfirmNo: 'Cancel',
    challengeCancelled: '❌ Challenge cancelled.',
    challengeErrSelf: '❌ You cannot challenge yourself.',
    challengeErrNoRecord: '❌ You have no record in this server\'s ranking yet — submit a score with `/update` first. Without a record there is no way to match an even opponent.',
    challengeErrRecordRange: '❌ **{name}**\'s record (**{score}**) differs from yours (**{record}**) by more than {percent}%. You can only challenge a player whose record is between **{min}** and **{max}**.',
    challengeErrLimit: '❌ You already have an open challenge — only one at a time is allowed. Finish it before starting another.',
    ...
    challengeDmInviteDesc: '**{challenger}** from **{guild}** challenges you on boss **{boss}**.',
    challengeDmInviteExpires: '⏳ You have until {date} to respond.',
    challengeBtnAccept: 'Accept',
    challengeBtnDecline: 'Decline',
    challengeBtnAccepted: 'Accepted',
    challengeBtnDeclined: 'Declined',
    challengeBtnExpired: 'Expired',
    challengeAcceptedReply: '⚔️ Challenge accepted! Submit **3 scores** on boss **{boss}** using `/update`.',
    challengeDeclinedReply: '❌ Challenge declined.',
    challengeErrNotForYou: '❌ This challenge is not addressed to you.',
    challengeErrGone: '❌ This challenge is no longer valid.',
    challengeErrAcceptLimit: '❌ You already have an open challenge — only one at a time is allowed. Finish it before accepting another.',
    challengeDmAcceptedTitle: '⚔️ Challenge accepted',
    ...
    challengeNoticeNoRunScore: '⚠️ The **result of this fight** (the number above "Best") could not be read, so the screenshot **was not counted** towards your challenge. Your record was saved normally — submit the image again to have it count towards the duel.',
    ...
    // ⚔️ Challenges — result
    challengeDmResultTitle: '⚔️ Challenge finished',
    challengeResultWin: '🏆 **You won!**',
    challengeResultLoss: '💔 **You lost.**',
    challengeResultDraw: '🤝 **A draw!**',
    challengeResultDesc: '**{a}** vs **{b}** — boss **{boss}**',
    challengeFieldSum: 'Total',
    challengeWinnerLine: '🏆 Winner: **{winner}**',
    challengeDrawLine: '🤝 A draw — both totals are identical.',
    challengeNoScores: '—',
    challengeBtnShare: 'Share the result on your server',
    challengeBtnShared: 'Shared',
    challengeSharedOk: '✅ Challenge result published on **{guild}**.',
    challengeSharedAlready: 'ℹ️ This result has already been published.',
    challengeShareNoChannel: '❌ **{guild}** has no bot channel configured — there is nowhere to publish the result.',
    ...
    challengeDeletedProfile: '🗑️ Deleted profile',
    challengeStatusWon: '🏆 Won',
    challengeStatusLost: '💔 Lost',
    challengeStatusDraw: '🤝 Draw',
    challengeStatusUnresolved: '❓ Unresolved',
    challengeStatusCancelled: '🚫 Cancelled',
    challengeStatusDeclined: '❌ Declined',
    challengeStatusExpired: '⏳ Expired',
    challengeStatusPending: '✉️ Awaiting response',
    challengeStatusActive: '⚔️ In progress',
};
