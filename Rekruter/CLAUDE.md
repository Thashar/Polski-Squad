...
- `clanRoleChangeService.js` - Powiadomienia o zmianach klanów/stanowisk; ignoruje administratorów i użytkowników którzy wyłączyli powiadomienia; `buildInitialCache()` pobiera wszystkich członków (bez limitu)
...
- `/powiadomienia` - bez parametru: toggle własnych powiadomień
- `/powiadomienia uzytkownik:@user` - tylko admin: toggle powiadomień dla wskazanego użytkownika
